    ...
    switch (culture) {
        ...
        case "es":
            localization =
            {
                ...
                days: {
                    // full day names
                    names: ["Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "S&aacute;bado"],
                    // abbreviated day names
                ...
                decimalseparator: '.',
                thousandsseparator: ',',
                pagergotopagestring: "Ir a p&aacute;gina:",
                pagershowrowsstring: "Filas a mostrar:",
                pagerrangestring: " de ",
                pagerpreviousbuttonstring: "anterior",
                pagernextbuttonstring: "siguiente",
                pagerfirstbuttonstring: "primero",
                pagerlastbuttonstring: "&uacute;ltimo",
                groupsheaderstring: "Arrastre una columna y suelte aqu&iacute; para agrupar por esa columna",
                ...
                filtershowrowstring: "Mostrar registros dónde:",
                ...
                filterstringcomparisonoperators: ['vacío', 'no vacío', 'contenga', 'contenga(coincidir mayúsculas y minúsculas)',
                   'no contiene', 'no contiene(coincidir mayúsculas y minúsculas)', 'empieza con', 'empieza con(coincidir mayúsculas y minúsculas)',
                   'termina en', 'termina en(coincidir mayúsculas y minúsculas)', 'igual a', 'igual a(coincidir mayúsculas y minúsculas)', 'null', 'no null'],
                filternumericcomparisonoperators: ['igual a', 'diferente de', 'menor a', 'menor a o igual a', 'mayor a', 'mayor a o igual a', 'null', 'no null'],
                filterdatecomparisonoperators: ['igual a', 'diferente de', 'menor a', 'menor a o igual a', 'mayor a', 'mayor a o igual a', 'null', 'no null'],
                filterbooleancomparisonoperators: ['igual a', 'diferente de'],
                validationstring: "El valor capturado no es v&aacute;lido",
                emptydatastring: "No se encontraron datos",
